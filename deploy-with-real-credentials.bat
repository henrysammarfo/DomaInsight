@echo off
REM DomaInsight Deployment Script with Real Credentials
REM This script deploys the backend to Fly.io with real Doma testnet credentials

echo 🚀 Deploying DomaInsight with Real Doma Testnet Credentials...

REM Set real environment variables for Fly.io
echo 📝 Setting environment variables...

REM API Key
flyctl secrets set DOMA_API_KEY="v1.2ab2b25922189b0a4eae6015f4e4808a2d8b40dec8c9d04e29281a82d9f2f0f1"

REM Private Key (REAL TESTNET KEY - KEEP SECURE!)
